        ...
        setTimeout(() => {
            if (type === 'normal') {
                videoData = [
                    ...
                    { title: 'Sex 2', src: 'normal/sex-3.mp4' },
                    { title: 'Sex 2', src: 'normal/sex-4.mp4' },
                    { title: 'Sex 2', src: 'normal/sex-5.mp4' },
                    { title: 'Sex 2', src: 'normal/sex-6.mp4' },
                    { title: 'Sex 2', src: 'normal/sex-7.mp4' },
                    { title: 'Sex 2', src: 'normal/sex-8.mp4' }
                ];
            } else if (type === 'gay') {
                videoData = [
